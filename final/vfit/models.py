...
#     rental_code = models.ForeignKey(rental_record, on_delete=models.CASCADE, related_name='reports')
#     report_date = models.DateField(auto_now_add=True)  # วันที่รายงาน
...
#     )
#     def __str__(self):
#         return f"Report {self.id} - {self.rental_code} ({self.status})"